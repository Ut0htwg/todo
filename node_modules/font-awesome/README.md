A feladat: todo
ok - A színeket, ikonokat és a betűtípust szabadon választhatod
ok - A checkboxoknak nem kell egyedi designt készíteni.
ok - Az alkalmazás localStorage-ben tárolja a teendőket.
ok - Az alkalmazás indításkor ellenőrzi vannak-e mentett teendők, ha igen, akkor betölti őket storage-ból.
ok - Felül szerepelnie kell a jelenlegi dátumnak
ok - Az input mező placholdere: Take the garbage out
A plusz jelre kattintva egy animáció kíséretében megjelenik az új teendő a listában, az input tartalma törlődik
ok - A teendő lista feletti mondatban (You have X pending items) látható, hogy szerepel a teendők száma, ez dinamikusan frissüljön mindig
...
ok - A Clear All-ra kattintva a még el nem végzett összes teendő törlésre kerül
-----------------------------------------
